...
func init() {
	...
	file4 := &embedded.EmbeddedFile{
		...
		FileModTime: time.Unix(1616367625, 0),

		Content: string("<!doctype html>\n<html>\n<head>\n    <title>{{.Name}} - Altium Viewer</title>\n    <script src=\"assets/embed.js\"></script>\n    <style>\n        html, body {\n            width: 100%;\n            height: 100%;\n            margin: 0;\n            padding: 0;\n        }\n    </style>\n</head>\n<body>\n<div class=\"altium-ecad-viewer\" data-project-src=\"{{.Id}}\" style=\"overflow: hidden;\"></div>\n</body>\n</html>"),
	}

	// define dirs
	dir3 := &embedded.EmbeddedDir{
		Filename:   "",
		DirModTime: time.Unix(1616367625, 0),
		ChildFiles: []*embedded.EmbeddedFile{
			file4, // "index.html.tmpl"
	...
	embedded.RegisterEmbeddedBox(`templates`, &embedded.EmbeddedBox{
		Name: `templates`,
		Time: time.Unix(1616367625, 0),
		Dirs: map[string]*embedded.EmbeddedDir{
			"": dir3,
		},
		Files: map[string]*embedded.EmbeddedFile{
			"index.html.tmpl": file4,
		},
	})
}
